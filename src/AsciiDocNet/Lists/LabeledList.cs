...
namespace AsciiDocNet.Lists
{
	/// <summary>
	/// A labeled list. Called also <see cref="https://docs.asciidoctor.org/asciidoc/latest/lists/description/">Description List in documentation</see>.
	/// </summary>
	/// <example>
	...
	public class LabeledList : IElement
	{
		...
		public override bool Equals(object obj)
		{
			...
			return obj.GetType() == GetType() && Equals((LabeledList)obj);
		}
